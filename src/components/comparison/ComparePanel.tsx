...
export function ComparePanel({ open, onOpenChange, preSelectedCard }: ComparePanelProps) {
  ...
  const comparisonSections = [
    { id: 'overview', title: 'Card Overview', rows: [{ key: 'name', label: 'Card Name' }, { key: 'banks.name', label: 'Bank' }, { key: 'card_type', label: 'Card Type' }, { key: 'rating', label: 'Rating', type: 'rating' }] },
