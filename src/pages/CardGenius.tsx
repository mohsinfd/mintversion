...
const CardGenius = () => {
              ...
              <PopoverContent className="w-80 p-6 bg-card rounded-xl shadow-2xl border-2 border-primary/20 z-50" align="start" sideOffset={8}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input id="pincode" type="text" placeholder="Enter your pincode" value={eligibilityData.pincode} onChange={e => setEligibilityData({
                    ...eligibilityData,
  ...
  return <>
      <Navigation />
      <div className="min-h-screen bg-gradient-primary pt-20 md:pt-24">{/* Added padding for nav */}
      {/* Welcome Dialog */}
