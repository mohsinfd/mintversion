...
export default function CardDetails() {
  ...
  // Group benefits by type for horizontal scroll
  const benefitCategories = card.product_benefits 
    ? Array.from(new Set(['All', ...card.product_benefits.map(b => b.benefit_type)]))
    : ['All'];
